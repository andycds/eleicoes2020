insert into eleicao (id, nome, cabecalho, rodape, inicio, fim, senha) values (1, 'Eleição Teste 1', 'Eleição 1', 'Obrigado por votar', CURRENT_TIMESTAMP(), '2021-06-11T23:30', 'master');
